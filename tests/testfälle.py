...
testcases = [
    ...
    {"ID": "T4", "question": "Welche neuen Lernformate diskutiert das Edu-Lab im Blog?", 
    ...
    {"ID": "T12", "question": "Sag mir etwas zu den Experimentiermodulen", 
     "requirements": ["F1", "F2", "F3", "F6", "F7"]},
    ...
    {"ID": "T15", "question": "Welche Blockchain-Projekte hat das Edu-Lab 2023 durchgeführt?", 
     "requirements": ["F3", "F4", "F6"]},
    {"ID": "T16", "question": "Wie kann der AI Thesis Coach bei wissenschaftlichen Arbeiten helfen?", 
     "requirements": ["F1", "F2", "F3", "F6", "F7"]},
    ...
    {"ID": "T19", "question": "Welche personenbezogenen Daten von Studierenden werden im Edu-Lab gespeichert?", 
     "requirements": ["F3", "F4"]},
    {"ID": "T20", "question": "Wann beginnt das Herbstsemester 2026?", 
     "requirements": ["F3", "F4"]},
]
